...
[English](README.md) · [Instalación para agentes IA](docs/AI_AGENT_INSTALL.es.md) · [Release v2.1.3](https://github.com/ulianbass/kerebrom/releases/tag/v2.1.3) · [Historial del repositorio](docs/BRANCHES.md)
