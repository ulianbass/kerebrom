...
[English](README.md) · [Instalación para agentes IA](docs/AI_AGENT_INSTALL.es.md) · [Release v2.1.9](https://github.com/ulianbass/kerebrom/releases/tag/v2.1.9) · [Historial del repositorio](docs/BRANCHES.md)
...
No usa transportes de red, no importa memoria, no borra memoria ni hace cambios de dependencias del sistema sin consentimiento del usuario. La única dependencia que puede ofrecer instalar automáticamente es Go mediante Homebrew cuando el usuario lo acepta explícitamente.
...
El target de Make delega al mismo instalador, así que las verificaciones de Go, las reglas de consentimiento para dependencias, la salida de versión/stats y la verificación con Doctor se mantienen consistentes.
...
- `kerebrom mcp-http` y `kerebrom serve` son transportes locales por defecto; exponer fuera de loopback requiere autenticación explícita o un override inseguro explícito.
