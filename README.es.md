...
[English](README.md) · [Instalación para agentes IA](docs/AI_AGENT_INSTALL.es.md) · [Release v2.0.4](https://github.com/ulianbass/kerebrom/releases/tag/v2.0.4) · [Historial del repositorio](docs/BRANCHES.md)
